...
const Privacy = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Build Your Own Story.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Build Your Own Story, accessible
            from{" "}
            <a
              href="https://byostory.com"
      ...
      <ul>
        <li>By email: support@byostory.com</li>
      </ul>
    </>
  );
};
