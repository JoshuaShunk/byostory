...
const Terms = () => {
  return (
    <>
      ...
      <p>
        The byostory.com website located at byostory.com is a copyrighted work
        belonging to byostory.com. Certain features of the Site may be subject
      ...
      <p>
        ...
        COMPLYING WITH THESE TERMS and you represent that you have the authority
        and capacity to enter into these Terms. YOU SHOULD BE AT LEAST 18 YEARS
        OF AGE TO ACCESS THE SITE. IF YOU DISAGREE WITH ALL OF THE PROVISIONS OF
      ...
      <p>
        ...
        without notice to you. You agree that Company will not be held liable to
        you or any third-party for any change, interruption, or termination of
      ...
      <p>
        ...
        byostory.com uses ‘cookies'. These cookies are used to store information
      ...
      <p>
        ...
        non-infringement. We and our suppliers make no guarantee that the site
      ...
      <p>
        <strong>Dispute Resolution.</strong> Please read this Arbitration
      ...
      <p>
        ...
        Company should be sent to: N/A. After the Notice is received, you and
        the Company may attempt to resolve the claim or dispute informally. If
        you and the Company do not resolve the claim or dispute within thirty
      ...
      <p>
        ...
        the personal jurisdiction of the courts located within US County,
      ...
      <p>Address: N/A</p>
      <p>Email: support@byostory.com</p>
    </>
  );
};
